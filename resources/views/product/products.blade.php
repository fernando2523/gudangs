...
<div id="content" class="app-content">
    <div class="d-flex align-items-center">
        ...
        <div class="ms-sm-3 mt-sm-0 mt-2"><a class="btn btn-outline-lime" data-bs-toggle="modal" data-bs-target="#modaladd"><i class="fa fa-plus-circle fa-fw me-1"></i> Stock Opname</a>
        </div>
        <div class="ms-sm-3 mt-sm-0 mt-2"><a class="btn btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modaladd"><i class="fa fa-plus-circle fa-fw me-1"></i> Add Product</a>
        </div>
    </div>
    <style>
        .button-hover {
    ...
    <div class="modal fade" id="modaladd" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="was-validated" method="POST" enctype="multipart/form-data" action="{{ url('/product/products/store') }}">
                    @csrf
                        ...
                        <div class="row form-group">
                            <div class="col-6">
                                <div class="row form-group">
                                    ...
                                    <div class="col-8 mt-2 form-group position-relative mb-2 profile-img" align="center">
                                        ...
                                        <img class="mb-2" id="previewimg" width="200px" src="/product/defaultimg.png">
                                        <input type="file" class="form-control" id="file" name="file" onchange="loadeditFile(event)">
                                    </div>
                                    ...
                                    <div class="col-12 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="produk" required placeholder="Please provide a name product" autocomplete="OFF">
                                    </div>
                                    ...
                                    <div class="col-6 form-group mb-3 mt-1">
                                        ...
                                        <input class="form-control form-control-sm text-theme is-invalid" type="number" name="m_price" required placeholder="0" autocomplete="OFF">
                                    </div>
                                    <div class="col-6 form-group mb-3 mt-1">
                                        <label class="form-label">Reseller</label>
                                        <input class="form-control form-control-sm text-theme is-invalid" type="number" name="r_price" required placeholder="0" autocomplete="OFF">
                                    </div>
                                    <div class="col-6 form-group mb-3 mt-1">
                                        <label class="form-label">Normal</label>
                                        <input class="form-control form-control-sm text-theme is-invalid" type="number" name="n_price" required placeholder="0" autocomplete="OFF">
                                    </div>
                                    <div class="col-6 form-group mb-3 mt-1">
                                        <label class="form-label">Grosir</label>
                                        <input class="form-control form-select-sm form-control-sm text-theme is-invalid" type="number" name="g_price" required placeholder="0" autocomplete="OFF">
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="row form-group">
                                    <div class="col-12 form-group position-relative mb-3">
                                        ...
                                        <select class="form-select form-select-sm text-theme fs-12px" name="id_sup" required>
                                    ...
                                    <div class="col-12 form-group position-relative mb-3">
                                        ...
                                        <select class="form-select form-select-sm text-theme fs-12px" id="type_variasi" name="type_variasi" required>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            while (i < length) {
                                if (row.warehouse[0]['id_ware'] === row.product_variation[i]['id_ware']) {
