                            ...
                            <div class="col-6">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="store" required placeholder="Please provide a name product" autocomplete="OFF">
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 form-group position-relative mb-3">
                                        ...
                                        <select class="form-select form-select-sm text-theme fs-12px" name="supplier" required>
