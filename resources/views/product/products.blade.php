                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col-12 form-group mb-3">
                                ...
                                <input class="form-control form-control-sm text-theme is-invalid" type="text" name="store" required placeholder="Please provide a name store" autocomplete="OFF">
                            </div>

                            <div class="col-12 form-group mb-3">
                                <label class="form-label">Address</label>
                                <textarea class="form-control form-control-sm text-theme is-invalid" type="text" name="address" required placeholder="Please provide a Adress store" autocomplete="OFF" rows="2"></textarea>
                            </div>
        ...
        var table = $('#tb_product').DataTable({
            ...
            columns: [{
                ...
                "render": function(data, type, row) {
                    ...
                    i = 0;
                    while (i < length) {
                        size = size + '<span class="fw-bold text-theme">' + ' | ' + row.product_variation[i]['size'] + '=' + row.product_variation[i]['qty'] + '</span>';
                        i++;
                    }
