        ...
        <div class="row">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <select class="form-select fw-bold  form-select-sm text-theme" id="select_store" name="store" required>
                            ...
                            <option data-upprice="{{ $stores->detailsarea[0]['up_price'] }}" data-area="{{ $stores->id_area }}" data-id_store="{{ $stores->id_store }}" value="{{ $stores->store }}">{{ $stores->store }} </option>
                            @endforeach
                        </select>
                        ...
                        <div class="input-group mb-4 row">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    ...
                                    <input type="search" class="form-control text-theme fw-bold form-control-sm ps-35px" id="search_product" placeholder="Search products.." disabled />
                                </div>
                            </div>
                        </div>
                        <hr>
            ...
            <div class="col-xl-7">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-3">
                        <select class="form-select fw-bold form-select-sm text-theme" id="reseller_name" name="reseller_name" disabled>
                        ...
                        <div class="input-group mb-4 row">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control text-theme fw-bold form-control-sm ps-35px" id="search_barcode" placeholder="Search barcode.." disabled />
                                </div>
                            </div>
                        </div>
                        <hr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3" align="center">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" placeholder="Cash Amount" min="0" id="r_cash" name="r_cash" value="" type-currency="IDR">
                    </div>
                </div>
                ...
                <div class="row mb-3" align="center">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" placeholder="BCA Amount" id="r_bca" name="r_bca" value="" type-currency="IDR">
                    </div>
                </div>
                ...
                <input class="form-control" type="hidden" placeholder="MANDIRI Amount" id="r_mandiri" name="r_mandiri" value="">
                ...
                <div class="row mb-3" align="center">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" placeholder="Qris Amount" id="r_banktf" name="r_banktf" value="" type-currency="IDR">
                    </div>
                </div>
                    ...
                    <div class="modal-pos-product">
                        ...
                        <div class="modal-pos-product-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <a onclick="addCart()" class="btn btn-success d-flex justify-content-center align-items-center rounded-0 py-3 h4 m-0">Add
