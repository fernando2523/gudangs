            ...
            <div class="modal-body">
                ...
                <div class="row form-group">
                    <div class="col-12 form-group position-relative mb-3">
                        ...
                        <input class="form-control formm-control-sm text-theme is-invalid" type="text" name="e_username" id="e_username" required placeholder="Please provide a name" autocomplete="OFF">
                    ...
                    <div class="col-6 form-group position-relative mb-2">
                        ...
                        <select class="form-select text-theme" name="e_role" id="e_role" required>
                            <option id="e_roledefault" selected>Select Role</option>
