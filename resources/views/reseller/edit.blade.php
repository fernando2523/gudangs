            ...
            <div class="modal-body">
                ...
                <div class="row form-group">
                    <div class="col-8 form-group mb-3">
                        ...
                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="e_nama" id="e_nama" required placeholder="Please provide a name supplier" autocomplete="OFF">
                    </div>

                    <div class="col-4 form-group mb-3">
                        <label class="form-label">No Telp</label>
                        <input class="form-control form-control-sm text-theme is-invalid" type="number" name="e_tlp" id="e_tlp" required placeholder="Please provide a No Telp" autocomplete="OFF">
                    </div>
                    ...
                    <div class="col-4 form-group position-relative mb-2 profile-img" align="center">
                        ...
                        <input type="file" style="width: 200px;" class="form-control form-control-sm" name="file">
                    </div>
