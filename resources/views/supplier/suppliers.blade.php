...
<div id="content" class="app-content">
    <div class="d-flex align-items-center">
        <div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="/location/locations">SUPPLIER</a></li>
        ...
        <div class="ms-sm-3 mt-sm-0 mt-2"><a class="btn btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modaladd"><i class="fa fa-plus-circle fa-fw me-1"></i> Add Supplier</a></div>
    </div>
    <style>
         .button-hover{
            padding:0.5%;
				...
				<div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-6 form-group mb-3">
                            ...
                            <input class="form-control formm-control-sm text-theme is-invalid" type="text" name="supplier" required placeholder="Please provide a name supplier" autocomplete="OFF">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
    
                        <div class="col-6 form-group mb-3">
                            <label class="form-label">No Telp</label>
                            <input class="form-control formm-control-sm text-theme is-invalid" type="number" name="tlp" required placeholder="Please provide a No Telp" autocomplete="OFF">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                    </div>
                    ...
                    <div class="input-group mb-4">
                        <div class="flex-fill position-relative">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control ps-35px" id="search_supplier" placeholder="Search supplier.." />
                            </div>
                        </div>
                    </div>
                    <table class="table-sm table-bordered mb-0" style="width: 100%" id="tb_supplier">
                        <thead style="font-size: 11px;">
                            <tr>
                                ...
                                <th class="text-center" width="10%" style="color: #a8b6bc !important;">ID SUPPLIER</th>
...
<script type="text/javascript">
    ...
    columns: [
        ...
        searchable: false},
        {data: 'id_sup', name: 'id_sup', class : 'text-center text-theme fw-bold',
        searchable: false},
        {data: 'supplier', name: 'supplier', class : 'text-center',
        searchable: true},
        {data: 'tlp', name: 'tlp', class : 'text-center',
        searchable: true},
        {data: 'action', name: 'action', class : 'text-center fw-bold',
                "render": function (data, type, row) {
                return '<span><a class="text-primary" style="cursor: pointer;" onclick="openmodaledit('+"'"+row.id+"'"+','+"'"+row.id_sup+"'"+','+"'"+row.supplier+"'"+','+"'"+row.tlp+"'"+')"><i class="fas fa-xl fa-edit">  </i></a> </span><span><a class="text-default" style="font-weight: bold;">|</a> </span><span><a class="text-danger" style="cursor: pointer;" onclick="openmodaldelete('+"'"+row.id+"'"+')"><i class="fas fa-xl fa-times-circle"></i></a></span>';
                },
            },
        ],
    dom: 'tip',
