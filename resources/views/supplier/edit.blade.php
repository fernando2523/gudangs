            ...
            <div class="modal-body">
                ...
                <div class="row form-group">
                    <div class="col-6 form-group mb-3">
                        ...
                        <input class="form-control formm-control-sm text-theme is-invalid" type="text" name="e_supplier" id="e_supplier" required placeholder="Please provide a name supplier" autocomplete="OFF">
                        <div class="valid-feedback">Looks good!</div>
                    </div>

                    <div class="col-6 form-group mb-3">
                        <label class="form-label">No Telp</label>
                        <input class="form-control formm-control-sm text-theme is-invalid" type="number" name="e_tlp" id="e_tlp" required placeholder="Please provide a No Telp" autocomplete="OFF">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                </div>
