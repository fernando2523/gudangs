            ...
            var table = $('#tb_store').DataTable({
                ...
                columns: [{
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        gross = 0;
                        for (i = 0; i < row.store_gross.length; i++) {
                    ...
                    data: 'store_disc_item',
                    name: 'store_disc_item',
                    class: 'text-center fw-bold',
                    searchable: true,
                    "render": function(data, type, row, meta) {
                        let rupiah = Intl.NumberFormat('id-ID');

                        return rupiah.format(row.store_disc_item[0]['disc']);
                    },
                }, {
                    data: 'store_gross',
                    name: 'store_gross',
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        netsales = gross - row.store_disc_item[0]['disc'];
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        costs = 0;
                        for (i = 0; i < row.store_costs.length; i++) {
