                            ...
                            <div class="flex-fill position-relative">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm ps-35px"
                                        id="search_quality" placeholder="Search quality.." />
                                </div>
                            </div>
                        </div>
            ...
            var table = $('#tb_quality').DataTable({
                ...
                columns: [{
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        gross = 0;
                        for (i = 0; i < row.quality_gross.length; i++) {
                    ...
                    data: 'quality_disc_item',
                    name: 'quality_disc_item',
                    class: 'text-center fw-bold',
                    searchable: true,
                    "render": function(data, type, row, meta) {
                        let rupiah = Intl.NumberFormat('id-ID');

                        return rupiah.format(row.quality_disc_item[0]['disc']);
                    },
                }, {
                    data: 'quality_gross',
                    name: 'quality_gross',
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        netsales = gross - row.quality_disc_item[0]['disc'];
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        costs = 0;
                        for (i = 0; i < row.quality_costs.length; i++) {
