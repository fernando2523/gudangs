    ...
    <div class="d-flex align-items-center">
        ...
        <div class="ms-auto">
            <div class="mt-3">
                ...
                <select class="form-select form-select-sm text-theme fw-bold" id="select_ware" onchange="select()" style="width: 300px;">
        ...
        <div class="ms-sm-3 mt-sm-3"><a class="btn btn-sm btn-outline-yellow" data-bs-toggle="modal" data-bs-target="#modaladd"><i class="fa fa-plus-circle fa-fw me-1"></i> RELEASE PRODUCT</a>
        </div>
    </div>
    <style>
        .button-hover {
    ...
    <div class="modal fade" id="modaladd" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="formadd" class="was-validated" method="POST" enctype="multipart/form-data" action="{{ url('/product/products/store') }}">
                    @csrf
                            ...
                            <div class="col-4">
                                <div class="row form-group">
                                    ...
                                    <div class="col-8 mt-2 form-group position-relative mb-2 profile-img" align="center">
                                        ...
                                        <img class="mb-2" id="previewimg" width="247px" src="/product/defaultimg.png">
                                    ...
                                    <div class="col-12 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="produk" required placeholder="Silahkan masukan nama produk" autocomplete="OFF">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="row form-group">
                                    ...
                                    <div class="col-6 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="m_price" required placeholder="0" autocomplete="OFF" type-currency="IDR">
                                    </div>
                                    <div class="col-6 form-group mb-3">
                                        <label class="form-label">Reseller</label>
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="r_price" required placeholder="0" autocomplete="OFF" type-currency="IDR">
                                    </div>
                                    <div class="col-6 form-group mb-3">
                                        <label class="form-label">Normal</label>
                                        <input class="form-control form-control-sm text-theme is-invalid" type="text" name="n_price" required placeholder="0" autocomplete="OFF" type-currency="IDR">
                                    </div>
                                    <div class="col-6 form-group mb-3">
                                        <label class="form-label">Grosir</label>
                                        <input class="form-control form-select-sm form-control-sm text-theme is-invalid" type="text" name="g_price" required placeholder="0" autocomplete="OFF" type-currency="IDR">
                                    </div>
